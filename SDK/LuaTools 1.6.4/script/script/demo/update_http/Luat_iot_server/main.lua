...
2、如果需要定时执行升级功能，打开--updatehttp.setperiod(3600)的注释，根据自己的需要，配置定时周期
3、如果需要实时执行升级功能，参考--sys.timer_start(updatehttp.request,120000)，根据自己的需要，调用updatehttp.request()即可
]]
require"updatehttp"
